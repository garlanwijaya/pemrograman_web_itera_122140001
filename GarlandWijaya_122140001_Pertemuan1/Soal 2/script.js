...
function hitungKalkulator(angka1, angka2, operasi) {
  console.log(`hitungKalkulator(${angka1}, ${angka2}, '${operasi}')`);
  let hasil = 0;
  switch (operasi) {
    case "tambah":
      hasil = angka1 + angka2;
    ...
    case "bagi":
      if (angka2 === 0) {
        console.error("Error: Pembagian dengan nol tidak diperbolehkan");
    ...
    case "modulus":
      ...
      break;
    default:
      console.error(`Error: Operasi '${operasi}' tidak valid`);
      return `Error: Operasi '${operasi}' tidak valid`;
  }
